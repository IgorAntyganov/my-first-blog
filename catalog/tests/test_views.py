...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user1.save()
        test_user2 = User.objects.create_superuser(username='testuser2', password='12345', email='ialjfds@uauf.oajf') 
        test_user2.save()
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(resp, reverse('renew-book-librarian') )
...
class AuthorCreateViewTest(TestCase):
	def setUp(self):
		testuser1 = User.objects.create_user(username = 'First_User', password = '12345')
		testuser2 = User.objects.create_user(username = 'Second_User', password = '12345')
		permission = Permission.objects.get(name='Work with authors')
		testuser2.user_permissions.add(permission)
		testuser1.save()
		testuser2.save()

	def test_redirect_if_not_logged_in(self):
		reps = self.client.get(reverse('author_create'))
		self.assertEqual(reps.status_code,302)

	def test_cheking_correct_date_of_birth_and_date_of_die(self):
		login = self.client.login(username='Second_User',password='12345')
		reps = self.client.post(reverse('author_create'), {'date_of_birth':'204DS0-2010','date_of_death':'21-10-2010'})
		self.assertFormError(reps,'form','date_of_birth','Enter a valid date.')